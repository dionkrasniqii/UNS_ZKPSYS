...
const ApplicationEditProfessor = () => {
  ...
  useEffect(() => {
    Promise.all([
      ...
      CrudProvider.getAll("GeneralAPIController/GetBanka").then((res) => {
        if (res) {
          if (res.statusCode === 200) {
            setBankat(res.result);
          }
        }
      }),
    ]);
                ...
                <div className='col-xxl-12'>
                  <div className='row'>
                    ...
                    <div className='col-xxl-2 col-lg-2'>
                      <div className='form-group'>
                        <label>
                          Autore kryesore <span className='text-danger'>*</span>
                        </label>
                        <Select
                          name='autorKryesor'
                          placeholder='Zgjedhni'
                          defaultValue={applicant.autoreKryesorId}
                          style={{ width: "100%" }}
                          onChange={(e) => {
                            setModel({
                              ...newModel,
                    ...
                    <div className='col-xxl-2 col-lg-2'>
                      <div className='form-group'>
                        ...
                        {/* ME I BO FILTER PROFESORAT MOS ME I QIT ATA QE JANE TSELEKTUN */}
                        <Select
                          placeholder='Zgjedhni'
                          style={{ width: "100%" }}
                          mode='multiple'
                          maxTagCount='responsive'
                          defaultValue={newModel.AutorKorrespodentId}
                          onChange={(e) => {
                            setModel({
                              ...newModel,
                    ...
                    <div className='col-xxl-2 col-lg-2'>
                      <div className='form-group'>
                        <label>
                          Bashke autoret <span className='text-danger'>*</span>
                        </label>
                        <Select
                          placeholder='Zgjedhni'
                          style={{ width: "100%" }}
                          mode='multiple'
                          maxTagCount='responsive'
                          defaultValue={newModel.BashkautoretId}
                          onChange={(e) => {
                            setModel({
                              ...newModel,
                              BashkautoretId: e,
                ...
                <div className='col-xxl-12'>
                  <div className='row'>
                    ...
                    <div className='col-xxl-2 col-lg-2'>
                      <div className='form-group'>
                        <label>
                          Data publikimit <span className='text-danger'>*</span>
                        </label>
                        <DatePicker
                          name='datapublikimit'
                      ...
                      <div className='form-group'>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            setModel({
                              ...newModel,
                              LlogariaBankare: e.target.value,
                            });
                          }}
