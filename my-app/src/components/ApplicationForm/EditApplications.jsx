                  ...
                  <div className='col-xxl-2 col-lg-2'>
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        readOnly
                        defaultValue={
                          applicant.autoretKorrespodent.map(
                            (obj) => obj.profesoriId
                          ) || ""
                        }
                      />
                  ...
                  <div className='col-xxl-2 col-lg-2'>
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        readOnly
                        defaultValue={
                          new Date(applicant.dataPranimit).toLocaleDateString(
                            "en-GB"
                          ) || ""
                        }
                      />
                  ...
                  <div className='col-xxl-2 col-lg-2'>
                    <div className='form-group'>
                      ...
                      <input
                        ...
                        readOnly
                        defaultValue={
                          new Date(applicant.dataPublikimit).toLocaleDateString(
                            "en-GB"
                          ) || ""
                        }
                      />
                        ...
                        >
                          <div className='modal-dialog'>
                            <div className='modal-content'>
                              ...
                              <div className='modal-body'>
                                {checkIsPDf(applicant.konferencDoc) == true ? (
                                  <iframe
