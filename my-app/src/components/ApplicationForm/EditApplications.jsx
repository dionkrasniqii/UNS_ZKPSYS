        ...
        <div className="px--40">
          <div className="row">
            ...
            <div className="col-lg-2">
              <Link className="rbt-btn-link-reverse" to={"/application/index"}>
                <i>
                  <svg
                ...
                {applicant && Object.keys(applicant).length > 0 && (
                  <div className="rbt-card-body border-bottom">
                    <div className="row">
                      {applicant.formulari.formulariId === 1 ? (
                        ...
                        <div className="d-block w-100">
                          <div className="col-xxl-12 col-lg-12 col-sm-12 text-center mb-5 rbt-border-bottom">
                            <h2 className="title">{t("DataOfApplicant")}</h2>
                          </div>
                          <div className="col-lg-12 rbt-border-dashed border-1 px-5 py-4 mb-5">
                            <div className="row">
                              <div className="col-lg-12">
                    ...
                    /> */}
                        ...
                        // Forma 2--------------------------------
                        <div>
                          <div className="col-xxl-12 col-lg-12 col-sm-12 my-5 rbt-border-bottom">
                            <div className="row">
                                ...
                                >
                                  <div className="modal-dialog">
                                    <div className="modal-content">
                                      ...
                                      <div className="modal-body">
                                        {checkIsPDf(applicant.abstrakti) ==
                                        true ? (
                                          <iframe
                                            src={CrudProvider.documentPath(
                                              applicant.abstrakti
                    ...
                    <div className="col-xxl-3 col-lg-3 d-flex align-items-center">
                      <Radio.Group
                        ...
                        onChange={(e) => {
                          setModel({
                            ...model,
                            StatusiKerkesesId: e.target.value,
                          });
                        }}
                        optionType="button"
                        buttonStyle="solid"
