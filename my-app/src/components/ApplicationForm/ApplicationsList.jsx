...
export default function ApplicationsList(props) {
  ...
  const columns = [
          ...
          <div className="text-start d-flex">
            ...
            {value === "Proces" && (
              <p className="d-flex justify-content-center align-items-center">
                <span className="rbt-badge-5 bg-warning text-white pt-2">
                  {t("Process")}
                </span>
                {/* <svg
            ...
            {value === "Rikthim" && (
              <p className="d-flex justify-content-center align-items-center">
                <label className="pe-2">{t("Relapse")}</label>
                <svg
                  viewBox="64 64 896 896"
                  focusable="false"
                  data-icon="exclamation-circle"
            ...
            {value === "Verifikuar" && (
              <p className="d-flex justify-content-center align-items-center small">
                <label className="pe-2">{t("Verified")}</label>
                <svg
                  viewBox="64 64 896 896"
                  focusable="false"
                  data-icon="exclamation-circle"
    ...
    },
    {
      ...
      render: (value, record) => {
        const id = btoa(value);
        if (record.statusiKerkesesId !== 4 && record.statusiKerkesesId !== 5) {
          return (
            <Link
